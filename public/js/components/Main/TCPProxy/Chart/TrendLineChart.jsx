...
var TrendLineChart = React.createClass({
  ...
  componentDidMount: function(){
    ...
    renderChart: function( data ){
        ...
        this.refs.chart.getChart().series[0].update({ data: data.totalbytes })
        this.refs.chart.getChart().series[1].update({ data: data.clearproxy })
    },
    ...
    render: function() {
      return (
            <div>
                ...
                <slider floor="0" ceiling="3" step="1">
