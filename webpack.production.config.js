...
module.exports = {
  ...
  plugins: [
    new ExtractTextPlugin('./dist/public/assets/css/app.css', { allChunks: true }),
    ...
    loaders: [
      {
        ...
        test: /\.(css|scss|pcss)$/,
        loaders: ExtractTextPlugin.extract("style-loader","css?-autoprefixer&-minimize&modules&importLoaders=1&localIdentName=[hash:base64:3]!postcss!sass")
      },{
        test: /\.png$/,
